...
let mainUser = shoesProducts.find(function (shoe) {
    return shoe.id == userIDParam
})

document.body.insertAdjacentHTML('afterbegin','<div class="navbar"><button id="back" onclick="backFunc()">Back</button></div><div class="details"><div class="desc"><h1>' + mainUser.title + '</h1><p>' + mainUser.detail + '</p></div><div class="image"><img src="' + mainUser.img +'"/></div></div>')
